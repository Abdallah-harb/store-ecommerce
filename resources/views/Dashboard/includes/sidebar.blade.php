    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.mainCategories.all')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.subcategories.all')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.brands.all')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.tags.all')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.products.all')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.attributes.all')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main"> سمات الخصائث  </span>
                    <span
                        class="badge badge badge-warning  badge-pill float-right mr-2"></span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.options.all')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('admin/sidebar.shipping_methods')}}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('shipping.method','free')}}"
                                   data-i18n="nav.templates.vert.classic_menu">{{__('admin/sidebar.free_shipping_methods')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('shipping.method','local')}}">{{__('admin/sidebar.local_shipping_methods')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('shipping.method','outer')}}"
                                   data-i18n="nav.templates.vert.compact_menu">{{__('admin/sidebar.outer_shipping_methods')}}</a>
                            </li>
                        </ul>
                    </li>
                </ul>
